...
<?php
	if (isset($_GET['botao'])) { //teste do envio do formulário 
		...
		if ($media>=6) {
			...
			echo "<p>Caro $nome, sua média final é $media e você foi aprovado!</p>";
		}else{
			$media=number_format($media,1,",",".");
			echo "<p>Caro $nome, sua média final é $media e você foi reprovado.</p>";
		}
	}
?>
<a href="media.php">Clique aqui verificar novamente.</a>